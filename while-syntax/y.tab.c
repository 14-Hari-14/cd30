...
{
  "\"end of file\"", "error", "\"invalid token\"", "WHILE", "RELOP",
  "CODE", "ID", "NUMBER", "'('", "')'", "$accept", "input", "stmt", "cond", YY_NULLPTR
};
