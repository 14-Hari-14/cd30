...
{
  "\"end of file\"", "error", "\"invalid token\"", "IF", "RELOP", "ID",
  "NUMBER", "ELSE", "CODE", "'('", "')'", "$accept", "input", "stmt",
...
{
       2,    10,    11,     3,     5,    12,     6,     8,     9,    13,
       0,     0,    14
};

static const yytype_int8 yycheck[] =
{
       0,     5,     6,     3,     9,     8,     5,     4,    10,     7,
      -1,    -1,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* stmt: IF '(' condition ')' CODE ELSE CODE  */
#line 17 "if.y"
